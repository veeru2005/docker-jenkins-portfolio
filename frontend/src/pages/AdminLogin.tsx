...
const API_BASE_URL = 'http://localhost:8083/portfolio_back1';
        ...
        <Grid xs={12} md={7} sx={{ display: 'flex', justifyContent: 'center', order: { xs: 2, md: 1 } }}>
          <div
            dangerouslySetInnerHTML={{
              __html: `<lottie-player src="/portfolio_front1/Login.json" background="transparent" speed="1" style="width:100%; max-width:500px;" loop autoplay></lottie-player>`,
            }}
          />
        </Grid>
